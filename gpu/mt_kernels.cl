...
__local float __x[13][N_d+3];
__local float __y[13][N_d+3];
__local float __t[13][N_d+3];


__local float4 __lat_r[13][N_d+3];
__local float4 __long_d[13][N_d+1];


if ( i<13 && j<N_d) {

__lat_r[i][j]=(float4)0.0f;
__long_d[i][j]=(float4)0.0f;
...
__kernel void mt_kernel2d_mg( // 2d kernel - multiple independend groups
const int          niters,                                                                   
__global float    x_inout[][13][N_d+3],                          
__global float    y_inout[][13][N_d+3],
__global float    t_inout[][13][N_d+3]
