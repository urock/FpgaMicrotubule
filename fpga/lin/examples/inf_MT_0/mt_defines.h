...
*/
const float Ax_1[13] = {-0.237f, -0.210f, -0.134f, -0.029f, 0.084f, 0.177f, 0.230f, 0.230f, 0.177f, 0.084f, -0.029f, -0.134f, -0.210f};
const float Ax_2[13] = {0.000f, -0.898f, -1.590f, -1.918f, -1.807f, -1.281f, -0.462f, 0.462f, 1.281f, 1.807f, 1.918f, 1.590f, 0.898f};
const float Ax_3[13] = {-0.458	-0.405	-0.260	-0.055	0.162	0.343	0.445	0.445	0.343	0.162	-0.055	-0.260	-0.405};
const float A_Bx_4[13] = {1.000f, 0.885f, 0.568f, 0.121f, -0.355f, -0.749f, -0.971f, -0.971f, -0.749f, -0.355f, 0.121f, 0.568f, 0.885};

const float Ay_1[13] = {-0.000f, 0.110f, 0.195f, 0.235f, 0.221f, 0.157f, 0.057f, -0.057f, -0.157f, -0.221f, -0.235f, -0.195f, -0.110f};
const float Ay_2[13] = {-0.000f, 0.213f, 0.377f, 0.455f, 0.428f, 0.304f, 0.110f, -0.110f, -0.304f, -0.428f, -0.455f, -0.377f, -0.213f};
const float Ay_3[13] = {1.932f, 1.711f, 1.098f, 0.233f, -0.685f, -1.446f, -1.876f, -1.876f, -1.446f, -0.685f, 0.233f, 1.098f, 1.711f};
const float A_By_4[13] = {0.000f, -0.465f, -0.823f, -0.993f, -0.935f, -0.663f, -0.239f, 0.239f, 0.663f, 0.935f, 0.993f, 0.823f, 0.465f};

const float Az_1 = -0.237f;
const float Az_2 = -0.458f;

const float Bx_1[13] = {-0.236f, -0.209f, -0.134f, -0.028f, 0.084f, 0.177f, 0.229f, 0.229f, 0.177f, 0.084f, -0.028f, -0.134f, -0.209f};
const float Bx_2[13] = {-0.000f, 0.898f, 1.590f, 1.918f, 1.807f, 1.281f, 0.462f, -0.462f, -1.281f, -1.807f, -1.918f, -1.590f, -0.898f};
const float Bx_3[13] = {0.458f, 0.406f, 0.260f, 0.055f, -0.162f, -0.343f, -0.445f, -0.445f, -0.343f, -0.162f, 0.055f, 0.260f, 0.406f};

const float By_1[13] = {-0.000f, 0.110f, 0.194f, 0.235f, 0.221f, 0.157f, 0.057f, -0.057f, -0.157f, -0.221f, -0.235f, -0.194f, -0.110f};
const float By_2[13] = {0.000f, -0.213f, -0.377f, -0.455f, -0.428f, -0.304f, -0.110f, 0.110f, 0.304f, 0.428f, 0.455f, 0.377f, 0.213f};
const float By_3[13] = {-1.932f, -1.711f, -1.098f, -0.233f, 0.685f, 1.446f, 1.876f, 1.876f, 1.446f, 0.685f, -0.233f, -1.098f, -1.711f};

const float Bz_1 = -0.236f;
const float Bz_2 = 0.458f;
...
#define nullHigh 16        //indent from top at the beginning
